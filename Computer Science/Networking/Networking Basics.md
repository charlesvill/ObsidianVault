...
- *ICMP* - Internet Control Message Protocol : helps root out connectivity problems and routing	- /24 is the most common subnet mask for local end-user networks 
...
- every device on an ethernet network have a *MAC address* or Media Access Control Address
